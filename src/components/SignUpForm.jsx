    ...
    <div className="signup-container d-flex">
      ...
      <div className="left-description d-flex flex-column justify-content-center p-4">
        ...
        <p className="signup-description">
          This music streaming platform is a final semester project developed by{" "}
          <span className="pink-text">Zahid Rafeeq</span>, a student of BS
          Computer Science at The Islamia University of Bahawalpur. Join now to
          explore and experience the features built with modern frontend
          technologies.
        </p>
      </div>
